...
const DosePane = (props) => {
  ...
  const handleDelete = () => {
    axios.post(`http://localhost:8000/dashboard/covid/vaccination/${vaccinationsID}/delete/${dose._id}`)
  }
  ...
  return(
    <div className="doses">
      ...
      <div className="vaccine-card-buttons">
        ...
        <AddVaccine open={open} handleOpen={handleEditOpen} handleClose={handleEditClose} doseData={dose} vaccinationsID={vaccinationsID} doseId={dose._id} />
        <IconButton aria-label="delete" onClick={handleDelete} style={{ color: '#FF4949' }}>
